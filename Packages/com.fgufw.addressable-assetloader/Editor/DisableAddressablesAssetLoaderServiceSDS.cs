...
public static class DisableAddressablesAssetLoaderServiceSDS
{
    private const string sdsMenu = "Conditional/DisableAddressablesAssetLoaderServiceSDS";
    private const string sdsId = "DisableAddressablesAssetLoaderServiceSDS";
